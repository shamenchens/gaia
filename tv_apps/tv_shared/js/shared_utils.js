...
(function(exports) {
  ...
  exports.SharedUtils = {
    ...
    **/
    ...
    /**
     * Localize html element from payload, support l10n-id, l10n-args, or plain
     * string format. See http://mzl.la/1yoNtZ1 for l10n refernce.
     * @param  {HtmlElement} element target html element to localized
